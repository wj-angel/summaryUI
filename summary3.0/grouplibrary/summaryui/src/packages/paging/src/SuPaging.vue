<template>
  <div>
    <div class="pagingbox">
      ...
      <div class="info fl">
        <p>当前页数：<span id="current1">{{currentPage}}</span></p>
      </div>
    </div>
  </div>
</template>
        ...
        !function (a) {
          ...
          e.prototype = {
            init: function () {
              ...
              return d + '<input type="text" style="height:20px;width:50px;margin-top: -4px;border:1px solid #ccc;" placeholder="GO..." /><a class="ui-pagination-page-btn" href="javascript:void(0);">跳转</a>'
...
<style>
  @import "../../libs/theme/pagination.css";
</style>

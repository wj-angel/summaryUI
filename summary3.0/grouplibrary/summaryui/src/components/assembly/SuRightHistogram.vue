<template>
  <div class="right-cont">
    ...
    <div class="info-side">
      <h1>展示效果:</h1>
      <div class="hljsl">
       <su-right-histogram-cont></su-right-histogram-cont>
      </div>
    </div>
  </div>
</template>
...
<script>
    import SuRightHistogramCont from "./SuRightHistogramCont";
    export default {
        name: "SuRightHistogram",
      components: {SuRightHistogramCont},
      data(){
        return{
          "link":"<template>\n" +

<template>
  <div class="right-cont">
    ...
    <div class="info-side">
      <h1>展示效果:</h1>
      <div class="hljsl">
        <su-right-line-charts-cont></su-right-line-charts-cont>
      </div>
    </div>
  </div>
</template>
...
<script>
    import SuRightLineChartsCont from "./SuRightLineChartsCont";
    export default {
        name: "SuRightLineCharts",
      components: {SuRightLineChartsCont},
      data(){
        return{
          "link":"<template>\n" +
